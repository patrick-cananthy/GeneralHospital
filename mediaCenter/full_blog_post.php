...
<link href="https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap" rel="stylesheet">
    ...
    <style>
        /* Specific styling for full blog page */
        .full-blog {
            padding: 50px 0;
        }
        ...
        .full-blog .card-img-top {
            max-height: 400px;
            object-fit: cover;
        }

        .full-blog .card-title {
            font-size: 2.5rem;
            font-weight: bold;
            color: #333;
            margin-bottom: 20px;
        ...
        .full-blog .card-footer {
            background-color: #f8f9fa;
            border-top: none;
        }

        /* Recent posts side panel */
        .side-panel {
            background-color: #f8f9fa;
            padding: 20px;
            border-radius: 10px;
...
<body>
  ...
  <div id="spinner"
    ...
    <div class="container-fluid py-2 d-none d-lg-flex fw-bold" style="background-color: #00FF33;">
        <div class="container">
            <div class="d-flex justify-content-between">
                <div>
                    <small class="me-3 text-white"><i class="fa fa-map-marker-alt me-2"></i>Tema Community 12, Tema, Ghana</small>
    ...
    <!-- Brand Start -->
    <div class="container-fluid bg-white text-primary pt-4 pb-5 d-none d-lg-flex brand">
                    ...
                    <div class="navbar-nav">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu bg-light m-0">
                                <a href="overview.html" class="dropdown-item">Overview of TGH</a>
                                <a href="history.html" class="dropdown-item">History & Background</a>
                                <a href="governance.html" class="dropdown-item">Governance Structure</a>
                                <a href="seniorManagement.html" class="dropdown-item">Senior Management</a>
                            </div>
                        </div>
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Our Services</a>
                            <div class="dropdown-menu bg-light m-0">
                                <a href="generalCare.html" class="dropdown-item">General Care Services</a>
                                <a href="specialized.html" class="dropdown-item">Specialized Services</a>
                                <a href="diagnostic.html" class="dropdown-item">Diagnostic Services</a>
                            </div>
                        </div>
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Media Center</a>
                            <div class="dropdown-menu bg-light m-0">
                                <a href="news.html" target="_blank" class="dropdown-item">TGH News</a>
        ...
        <div class="row">
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-footer text-muted">
                                <a href="tghNews.php" class="btn btn-primary"><i class="fas fa-arrow-left"></i> Back to Blog</a>
                            </div>
                        </div>
                        <?php
                    } else {
                        echo "<p>No blog post found with the provided ID.</p>";
                    }
                } else {
                    echo "<p>No blog post ID provided.</p>";
                }
            ...
            <div class="col-lg-4">
                <div class="side-panel">
                    <h5>Recent Posts</h5>
                    <?php
                    // Include database connection for recent posts
                    include("admin/include/db_connection.php");

                    // Fetch recent posts for the side panel
                    $recent_posts_sql = "SELECT id, title FROM posts ORDER BY date DESC LIMIT 5";
                    ...
                    if ($recent_posts_result->num_rows > 0) {
                        while ($recent_post = $recent_posts_result->fetch_assoc()) {
                            echo '<a href="full_blog_post.php?id=' . $recent_post["id"] . '">' . $recent_post["title"] . '</a>';
                    ...
                    // Close database connection for recent posts
                    $conn->close();
                    ?>
                </div>
            </div>
...
<script src="../lib/wow/wow.min.js"></script>
    ...
    <script src="../l   ib/owlcarousel/owl.carousel.min.js"></script>
